  ...
  return (
    <section className="service">
      <div className="container">
        ...
        <p className="service__desc section-desc">Exceptional dental care for all ages. Your great smile begins with a great dentist.</p>

        <div className="service__row">
          {/* service left */}
          <figure>
            <img src="/assets/img/hero-1.jpg" alt="Our services" className="service__img" />
          </figure>
          {/* service right */}
          <div className="service__list">
            ...
            <section className="service-item">
              ...
              <div className="service-item__body">
                ...
                <div className="service-item__desc">Everything you expect and then some. Cleanings, fillings, and x-rays.</div>
              </div>
            </section>
            ...
            <section className="service-item">
              ...
              <div className="service-item__body">
                <div className="service-item__heading">Wisdom Teeth Removal</div>
                <div className="service-item__desc">Everything you expect and then some. Cleanings, fillings, and x-rays.</div>
              </div>
            </section>
            ...
            <section className="service-item">
              ...
              <div className="service-item__body">
                <div className="service-item__heading">Preventative Dentistry</div>
                <div className="service-item__desc">Everything you expect and then some. Cleanings, fillings, and x-rays.</div>
              </div>
            </section>
            
            <a href="#!" className="btn service__btn">All Services</a>
          </div>
        </div>
      </div>
    </section>
